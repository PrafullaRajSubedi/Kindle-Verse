...
namespace Kindle_Verse.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<OrderDto>> CreateOrder([FromQuery] int userId, [FromBody] CreateOrderDto orderDto)
        {
        ...
        [HttpPut("{id}/status")]
        public async Task<IActionResult> UpdateOrderStatus(int id, [FromQuery] int userId, [FromBody] UpdateOrderStatusDto statusDto)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
