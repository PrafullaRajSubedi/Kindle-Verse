...
import SearchPanel from "./SearchPanel"; // We'll create this component
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Search Panel Modal */}
      {searchPanelOpen && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-40 flex items-start justify-center pt-20">
          <div
            ref={searchPanelRef}
            className="bg-white rounded-lg shadow-xl w-full max-w-3xl mx-4 animate-slide-down"
          >
            <SearchPanel
